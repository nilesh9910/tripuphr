    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='No History', max_length=1000, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Employee',
            fields=[
                ...
                ('acc_no', models.CharField(default='0123456789', max_length=10)),
                ('bank', models.CharField(default='Band', max_length=25)),
